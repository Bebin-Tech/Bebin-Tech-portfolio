    ...
    <section id="projects" className="section-padding repository-section">
      <div className="repository-container">
        <div className="repository-heading">
          <div><p className="section-label">Selected work</p><h2 className="section-title">Projects & Applications</h2></div>
          <p className="section-subtitle">Explore the code, documentation, and implementation behind my projects.</p>
        </div>
        <div className="repository-grid">
          {projects.map((project) => (
            <article className="repository-card" key={project.id}>
              <div className="repository-card-top"><span className="repository-icon"><FolderGit2 size={23}/></span><span className="repository-label">SOURCE CODE</span></div>
              <h3>{project.title}</h3>
